...
13. **git pull** - скачивание всех данных с удалённого репозитория и автоматический merge с нашей версией.

14. **git push** - отвравка нашей версии репозитория на внешний репозиторий.
